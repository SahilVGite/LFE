    ...
    <>
      ...
      >
        <div className='main-wrapper pt-14 flex flex-col justify-center items-center relative'>
            <h2 className='commonTitle'>Reference Cases</h2>
            <span className='absolute -bottom-4 md:-bottom-6 lg:-bottom-10 right-[12dvw] lg:right-[3.5dvw] tracking-[0.0125em] smallTxt text-[#1A202C] font-medium'>Home  &gt;  Reference Cases</span>
        </div>
      </div>
      <CaseListing />
    </>
